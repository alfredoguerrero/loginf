        ...
        <div class="col-md-4 col-md-offset-4"><!--col-md-4 is used to create the no of colums in the grid also use for medimum and large devices-->
            <div class="login-panel panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <center><b>¿Ya tienes cuenta?</b> <br></b><a href="login.php">Inicia sesion aqui</a></center><!--for centered text-->
                </div>
            </div>
        </div>
    </div>
...
if(isset($_POST['register']))
{
    ...
    if($user_name=='')
    {
        ...
        echo"<script>alert('Porfavor ingresa un nombre')</script>";
exit();//this use if first is not work then other will not show
    }

    if($user_pass=='')
    {
        echo"<script>alert('Porfavor ingresa una contraseña')</script>";
exit();
    }

    if($user_email=='')
    {
        echo"<script>alert('Porfavor ingresa un correo elctronico')</script>";
    exit();
    }
